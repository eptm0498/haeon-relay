...
export default function TimerOverlay({ pin }: { pin: string }) {
  ...
  return (
    <>
      {broadcastEndAt && (
        <div className="pointer-events-none fixed left-[max(12px,calc((100vw-640px)/2-144px))] top-5 z-[110] w-[132px] max-[920px]:hidden">
      ...
      {hasRightPanel && (
        <div className="pointer-events-none fixed right-[max(12px,calc((100vw-640px)/2-144px))] top-5 z-[110] flex w-[132px] flex-col gap-1.5 max-[920px]:hidden">
      {gag && (
